  ...
  const speedDialActions = [
    {
      ...
      label: "Add Property",
      path: "/host-dashboard",
      color: "bg-hiddy-coral hover:bg-hiddy-coral/90",
      delay: 0,
    },
    {
      icon: Calendar,
      label: "Book Now",
      path: "/search",
      color: "bg-hiddy-teal hover:bg-hiddy-teal/90",
      delay: 0.1,
    },
    {
      icon: BookOpen,
      label: "My Bookings",
      path: "/bookings",
      color: "bg-hiddy-sunset hover:bg-hiddy-sunset/90",
      delay: 0.2,
    },
    {
      icon: TrendingUp,
            ...
            speedDialActions.map((action, index) => (
              ...
              >
                ...
                <Button
                  ...
                  asChild
                >
                  <NavLink to={action.path} onClick={handleNavigation}>
                    <action.icon size={20} />
      ...
      {showFAB && !user && (
        <div className="fixed bottom-20 right-4 z-40">
          <Button
            ...
            asChild
          >
            <NavLink to="/auth" onClick={handleNavigation}>
              <User size={24} />
