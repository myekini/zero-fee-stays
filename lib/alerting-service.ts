...
class AlertingService {
  ...
  // Utility methods
  dismissAll() {
    // Note: The toast library doesn't have a global dismiss method
    // Individual toasts can be dismissed by their ID
    console.log(
      "Dismiss all toasts - not implemented in current toast library"
    );
  }
